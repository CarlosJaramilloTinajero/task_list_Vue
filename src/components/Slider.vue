...
<template>
  <div class="slider-left">
    <div :class="{ 'opacity-0': !expandedSlider }" style="transition: opacity .8s ease-in-out;">
      ...
      <router-link to="/" class="link-container">
        ...
        <div class="link">Tablero</div>
      </router-link>

      <router-link to="/task-archived" class="link-container">
        ...
        <div class="link">Tareas archivadas</div>
      </router-link>

      <router-link to="/list-archived" class="link-container">
        ...
        <div class="link">Listas archivadas</div>
      </router-link>
    </div>
...
.slider-left .link-container:hover {
  background-color: rgba(255, 255, 255, 0.1);
}

.slider-left .link-container svg {
  color: white;
  width: 20px;
  height: 20px;
  margin-right: 15px;
...
.slider-left .link-container .link {
  text-decoration: none;
  color: white;
  font-size: 15px;
...
.slider-left .user-space {
  width: 100%;
  display: flex;
  grid-gap: 10px;
}

.slider-left .user-space .icon {
  padding: 30px 5px 20px 20px;
}

.slider-left .user-space .name-user {
...
.slider-left .user-space .icon svg {
  color: rgba(255, 255, 255, 0.9);
  width: 33px;
  height: 33px;
}
